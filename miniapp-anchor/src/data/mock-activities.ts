...
const activityDetailMap: Record<string, ActivityDetailItem> = {
  'activity-gift-1': {
    ...
    formConfig: {
      ...
      giftItems: [
        { itemName: '鲜花', unitPriceYuan: 1 },
        { itemName: '掌声', unitPriceYuan: 0.5 },
        { itemName: '气球', unitPriceYuan: 2 },
      ],
      rewardRules: [
        {
          itemName: '鲜花',
      ...
      rewardRules: [
        {
          ...
          threshold: 3000,
          maxThreshold: 5999,
          rangeLabel: '3000–5999',
          rewardType: 'cash',
          rewardLabel: 'PK 3000–5999，奖励 30 元',
          compareMode: 'range',
        ...
        },
        {
          ...
          threshold: 6000,
          maxThreshold: 9999,
          rangeLabel: '6000–9999',
          rewardType: 'cash',
          rewardLabel: 'PK 6000–9999，奖励 88 元',
          compareMode: 'range',
